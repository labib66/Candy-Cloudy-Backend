...
const CheckoutRoutes = React.lazy(() => import("./assets/checkout-routes-5cb1ac52.mjs"));
...
const AdminRoutes = React.lazy(() => import("./assets/admin-routes-a16e14a7.mjs").then((n) => n.z));
const DriveRoutes = React.lazy(() => import("./assets/drive-routes-90536317.mjs"));
